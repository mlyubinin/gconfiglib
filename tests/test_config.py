...
#         ValueError, "Mandatory node /no_such_section is missing, with no defaults set"
#     ) as e:
...
#     with nose.tools.assert_raises_regexp(
#         ValueError, "Expecting /general/log_level to be of type <type 'int'>"
#     ) as e:
#         template.validate(cfg.root())
...
#     with nose.tools.assert_raises_regexp(
#         AttributeError, "'ConfigNode' object has no attribute 'value'"
#     ) as e:
#         template.validate(cfg.root())
...
#     template.add(general)
#     with nose.tools.assert_raises_regexp(
#         ValueError, "Parameter /general/log_level failed validation for value debug"
#     ) as e:
#         template.validate(cfg.root())
...
#         "varnode", cfg.TemplateAttributeVariable(validator=lambda x: x in ["YES", "NO"])
#     )
#     with nose.tools.assert_raises_regexp(
#         ValueError, "Parameter /varnode/attr2 failed validation for value yes"
#     ) as e:
#         template.validate(
...
#     )
#     with nose.tools.assert_raises_regexp(
#         ValueError, "Node /varnode cannot be empty"
#     ) as e:
...
#     general.add(
#         cfg.TemplateAttributeFixed(
#             "no_update", optional=False, validator=lambda x: x.upper() in ["YES", "NO"]
#         )
#     )
...
#             return False
#         elif (
#             spec["method"] in ["ftp", "sftp", "http", "s3"] and "url" not in spec.keys()
#         ):
...
#     )
#     source_spec.add(
#         cfg.TemplateAttributeFixed("csv_header_row", value_type=int, default_value=0)
#     )
...
#     source_spec.add(
#         cfg.TemplateAttributeFixed("start_interval", value_type=int, default_value=0)
#     )
#     source_spec.add(
#         cfg.TemplateAttributeFixed(
#             "granularity",
...
#             print(
#                 "%s fieldspec should have %d attributes" % (value[0], sizes[value[1]])
#             )
#             return False
...
#     template.add(
#         cfg.TemplateNodeSet(
#             "source_field_spec", source_field_spec, [x + "_fields" for x in source_list]
#         )
#     )
